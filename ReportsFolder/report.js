$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/PatientGrid/CarePlan/Based On Patient Medical Record/WIPBySaveCloseBtn.feature");
formatter.feature({
  "name": "Care Plan - Reject Status Using SaveClose Button",
  "description": "",
  "keyword": "Feature",
  "tags": [
    {
